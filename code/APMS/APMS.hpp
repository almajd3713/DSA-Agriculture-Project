    ...
    cout << dye::blue("What would you like to access?") << endl
      ...
      switch(input) {
        ...
        case 4:
          ...
          for(int i = 0; i < categories.size(); i++) 
            cout << i << ": " << categories[i - 1] << endl;
          cout << categories.size() << ": Show for all categories" << endl;
          promptAndValidate(input, "Enter your query: ", 1, categories.size());
          promptAndValidate(year, "Enter the year you want: ");
          promptAndValidate(month,"Enter the month you want: ", 1, 12);
          if(input == categories.size())
            for(const string& cat: categories) 
    ...
    case 1:
      ...
      case 5:
        ...
        if (desired)
          ...
          cout << "ERR: Farmer with this ID was not found" << endl;
        displayMenu = true;
        return;
      case 6:
        cout << dye::red_on_white("WARNING: ") << "This will print the entire database, resulting in " << dye::green("MILLIONS") << " of lines. Depending on your hardware, " << dye::black_on_white("the 3ND 0F TH3 UN1V3RS3") << " may come before its done printing. Are you sure you want to proceed? (1 for yes, 0 for no)" << endl;
...
private:
  ...
  void print_monthly_land_sales(int landid, int year, int month)
  {
    ...
    else
    {
      ...
      if (result != 0)
      {
        cout << "the total sales of the land " << landid << " in the month " << month << " of the year " << year << " is :" << result << (result > 1000000 ? result / 1000000 : result > 1000 ? result / 1000
                                                                                                                                                                                              : result);
        cout << (result > 1000000 ? "MDA" : result > 1000 ? "KDA"
                                                          : "DA")
             << endl;
      }
      else
  ...
  void print_yearly_land_sales(int landid, int year)
  {
    ...
    else
    {
      ...
      if (result != 0)
      {
        cout << "the total sales of the land " << landid << " in the year " << year << " is :" << result << (result > 1000000 ? result / 1000000 : result > 1000 ? result / 1000
                                                                                                                                                                 : result);
        cout << (result > 1000000 ? "MDA" : result > 1000 ? "KDA"
                                                          : "DA")
             << endl;
  ...
  void print_monthly_area_sales(int areaid, int year, int month)
  {
    ...
    else
    {
      ...
      if (result != 0)
      {
        cout << "the total sales of the area " << area->getName() << "with ID : " << areaid << " in the month " << month << " of the year " << year << " is :" << result << (result > 1000000 ? result / 1000000 : result > 1000 ? result / 1000
                                                                                                                                                                                                                                 : result);
        cout << (result > 1000000 ? "MDA" : result > 1000 ? "KDA"
                                                          : "DA")
             << endl;
  ...
  void print_yearly_area_sales(int areaid, int year)
  {
    ...
    else
    {
      ...
      if (result != 0)
      {
        cout << "the total sales of the area " << area->getName() << "with ID : " << areaid << " of the year " << year << " is :" << result << (result > 1000000 ? result / 1000000 : result > 1000 ? result / 1000
                                                                                                                                                                                                    : result);
        cout << (result > 1000000 ? "MDA" : result > 1000 ? "KDA"
                                                          : "DA")
             << endl;
  ...
  void print_monthly_city_sales(int cityid, int year, int month)
  {
    ...
    else
    {
      ...
      if (result != 0)
      {
        cout << "the total sales of the city " << city->getName() << "with ID : " << cityid << " in the month " << month << " of the year " << year << " is :" << result << (result > 1000000 ? result / 1000000 : result > 1000 ? result / 1000
                                                                                                                                                                                                                                 : result);
        cout << (result > 1000000 ? "MDA" : result > 1000 ? "KDA"
                                                          : "DA")
             << endl;
  ...
  void print_yearly_city_sales(int cityid, int year)
  {
    ...
    else
    {
      ...
      if (result != 0)
      {
        cout << "the total sales of the city " << city->getName() << "with ID : " << cityid << " in the year " << year << " is :" << result << (result > 1000000 ? result / 1000000 : result > 1000 ? result / 1000
                                                                                                                                                                                                    : result);
        cout << (result > 1000000 ? "MDA" : result > 1000 ? "KDA"
                                                          : "DA")
             << endl;
  ...
  void print_monthly_wilaya_sales(int wilayaid, int year, int month)
  {
    ...
    else
    {
      ...
      if (result != 0)
      {
        cout << "the total sales of the wilaya " << wilaya->getName() << "with ID : " << wilayaid << " in the month " << month << " of the year " << year << " is :" << result << (result > 1000000 ? result / 1000000 : result > 1000 ? result / 1000
                                                                                                                                                                                                                                       : result);
        cout << (result > 1000000 ? "MDA" : result > 1000 ? "KDA"
                                                          : "DA")
             << endl;
  ...
  void print_yearly_wilaya_sales(int wilayaid, int year)
  {
    ...
    else
    {
      ...
      if (result != 0)
      {
        cout << "the total sales of the wilaya " << wilaya->getName() << "with ID : " << wilayaid << " in the year " << year << " is :" << result << (result > 1000000 ? result / 1000000 : result > 1000 ? result / 1000
                                                                                                                                                                                                          : result);
        cout << (result > 1000000 ? "MDA" : result > 1000 ? "KDA"
                                                          : "DA")
             << endl;
  ...
  void print_monthly_country_info(int year, int month)
  {
    ...
    wilayas.iterate([year, month, &sum1, &sum2, &sum3](Wilaya *wilaya) -> bool
      ...
      return true; });
    // printing the sums
    cout << "the total sales of the country in the month " << month << " of the year " << year << " is :" << sum1 << (sum1 > 1000000 ? sum1 / 1000000 : sum1 > 1000 ? sum1 / 1000
                                                                                                                                                                    : sum1);
    cout << (sum1 > 1000000 ? "MDA" : sum1 > 1000 ? "KDA"
                                                  : "DA")
         << endl;
    cout << "the total water consumption of the country in the month " << month << " of the year " << year << " is :" << sum2 << (sum2 > 1000000 ? sum2 / 1000000 : sum2);
    cout << (sum2 > 1000000 ? "dam^3" : "m^3") << endl;
  ...
  void print_period_country_info(int year1, int month1, int year2, int month2)
  {
    ...
    // printing the sums
    cout << "the total sales of the country in the period from " << month1 << "/" << year1 << " to " << month2 << "/" << year2 << " is :" << sum1 << (sum1 > 1000000 ? sum1 / 1000000 : sum1 > 1000 ? sum1 / 1000
                                                                                                                                                                                                    : sum1);
    cout << (sum1 > 1000000 ? "MDA" : sum1 > 1000 ? "KDA"
                                                  : "DA")
         << endl;
  ...
  void print_yearly_country_info(int year, int choice)
  {
    ...
    wilayas.iterate([year, choice, &sum1, &sum2, &sum3, sy](Wilaya *wilaya) -> bool
      ...
      return true; });
    // printing the sums
    cout << "the total sales of the country in the year " << year << " is :" << sum1 << (sum1 > 1000000 ? sum1 / 1000000 : sum1 > 1000 ? sum1 / 1000
                                                                                                                                       : sum1);
    cout << (sum1 > 1000000 ? "MDA" : sum1 > 1000 ? "KDA"
                                                  : "DA")
         << endl;
  ...
  void print_period_country_sales(int year1, int month1, int year2, int month2)
  {
    ...
    if (result != 0)
    {
      cout << "the total sales of the country in the period from " << month1 << "/" << year1 << " to " << month2 << "/" << year2 << " is :" << result << (result > 1000000 ? result / 1000000 : result > 1000 ? result / 1000
                                                                                                                                                                                                              : result);
      cout << (result > 1000000 ? "MDA" : result > 1000 ? "KDA"
                                                        : "DA")
           << endl;
  ...
  void print_yearly_country_sales(int year)
  {
    ...
    if (result != 0)
    {
      cout << "the total sales of the country in the year " << year << " is :" << result << (result > 1000000 ? result / 1000000 : result > 1000 ? result / 1000
                                                                                                                                                 : result);
      cout << (result > 1000000 ? "MDA" : result > 1000 ? "KDA"
                                                        : "DA")
           << endl;
