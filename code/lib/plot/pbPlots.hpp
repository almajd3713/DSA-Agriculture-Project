...
void DrawXLabelsForPriority(double p, double xMin, double oy, double xMax, double xPixelMin, double xPixelMax, NumberReference *nextpb_Rectangle, RGBA *gridLabelColor, RGBABitmapImage *canvas, std::vector<double> *xGridPositions, StringArrayReference *xLabels, NumberArrayReference *xLabelPriorities, std::vector<pb_Rectangle*> *occupied, bool textOnBottom);
void DrawYLabelsForPriority(double p, double yMin, double ox, double yMax, double yPixelMin, double yPixelMax, NumberReference *nextpb_Rectangle, RGBA *gridLabelColor, RGBABitmapImage *canvas, std::vector<double> *yGridPositions, StringArrayReference *yLabels, NumberArrayReference *yLabelPriorities, std::vector<pb_Rectangle*> *occupied, bool textOnLeft);
