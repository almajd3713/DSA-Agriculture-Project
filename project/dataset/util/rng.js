...
const getName = () => {
    let genderNum = (0, exports.rndNum)(0, 20);
    let gender = genderNum < 4 ? 1 : 0;
    let name = `${gender ? (0, exports.rndFromArr)(NAMES_FEMALES) : (0, exports.rndFromArr)(NAMES_MALES)} ${(0, exports.rndFromArr)(NAMES_LAST)}`;
    return { gender, name };
};
